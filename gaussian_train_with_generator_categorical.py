...
def myGenerator():
    while 1:
        ...
        TZ = np.sum(stats.norm.logpdf(Z1, loc=0, scale=sigma) - stats.norm.logpdf(Z2, loc=0, scale=sigma))
        ...
        TXY = np.sum(
            stats.norm.logpdf(Y, loc=mu_vec, scale=sigmaXH1) + stats.norm.logpdf(Y, loc=muYH1, scale=sigmaYH1) -
...
print('Power ttest, theory: ', power_ttest_theory)
print('Power NN-test: ', power_nntest)

print('False alarm ttest: ', fa_ttest)
print('False alarm ttest, theory: ', fa_ttest_theory)
